package xyz.hollysys.spring.fileupload.controller;
...
import xyz.hollysys.spring.fileupload.util.FileValidator;
import xyz.hollysys.spring.fileupload.util.MultiFileValidator;
 
@Controller
public class FileUploadController {
 
    private static String UPLOAD_LOCATION="C:/";
